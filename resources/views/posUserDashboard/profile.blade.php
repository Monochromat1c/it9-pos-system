    ...
    <section class="kld--site kld--min-width-dvw-100">
        ...
        <main>
            ...
            <section class="kld--container kld--margin-top-1 responsive-container kld--margin-bottom-2">
                <form action="{{ route('updatePictureforUsers') }}" method="post"
                    ...
                    @if(Auth::user()->profile_picture)
                        <div
                            class="kld--display-flex kld--min-width-percent-100 kld--justify-center kld--margin-bottom-1">
                    ...
                    <button type="submit" class="kld--button-secondary kld--text-color-white kld--padding-button-2 kld--margin-bottom-1
                            kld--border-radius-medium kld--min-width-percent-100">
                        Upload
                    </button>
                </form>
                <hr class="kld--margin-bottom-1">
                <form action="{{ route('updatePasswordforUsers') }}" method="post">
                    @csrf
                    ...
                    <button type="submit"
                        class="kld--button-primary kld--text-color-white kld--padding-button-2 kld--border-radius-medium kld--min-width-percent-100 kld--margin-bottom-2 kld--margin-top-1">Update
                        Password
                    </button>
                </form>
